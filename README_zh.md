...
```bash
./audio8-tts-cli "Hello, this is Audio8 TTS."
```
...
```bash
./audio8-tts-cli "朋友们大家好，我是anthony。" anthony
```
...
```bash
./audio8-tts-cli "Hello, nice to meet you." tom
```
...
```bash
./audio8-tts-cli my_voice "This is the transcript of the reference audio." reference.wav
```
